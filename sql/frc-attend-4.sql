...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2014 at 07:55 AM
...
-- Database: `frc-attend`
--
CREATE DATABASE IF NOT EXISTS `frc-attend` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `frc-attend`;
...
DROP TABLE IF EXISTS `ptolemy_attendance`;
CREATE TABLE IF NOT EXISTS `ptolemy_attendance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `student_id` int(11) NOT NULL,
  `student_attendance` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `ptolemy_hours`;
...
DROP TABLE IF EXISTS `ptolemy_members`;
